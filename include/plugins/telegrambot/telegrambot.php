...
class TelegramPlugin extends Plugin {
	...
	function bootstrap() {
        ...
        Signal::connect('ticket.edit', array($this, 'onTicketEdit'), 'Ticket');
        Signal::connect('ticket.close', array($this, 'onTicketClose'), 'Ticket');
    }
